...
# Use a clean, professional Bootstrap theme from bootswatch.com
APP_THEME = dbc.themes.FLATLY

# Load environment variables (will raise an error if not found)
transactions_url = os.environ['TRANSACTIONS_URL']
products_url = os.environ['PRODUCTS_URL']


# --- Data Loading and Cleaning Functions (Your original functions, slightly tidied) ---
...
def clean_transactions_data(df):
    ...
    # Your comprehensive replace map is great, no changes needed here.
    replace_map = {
...
# --- Prepare Dropdown Options with "All Artists" ---
